...
def preprocess_data(petrol_df: pd.DataFrame, sales_df: pd.DataFrame):
    """Prepare the final dataset for training."""
    
    # Merge datasets if needed (based on date or state if available)
    # For now, assume sales_df is independent
